...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const sc = result.composite_score;
    result.risk_level = sc < 26 ? 'Minga mal' : sc < 51 ? 'Ocio' : sc < 76 ? 'Roba de matt' : 'Dàghela via';
